-- migration_boutique_cyberpunk.sql
-- Creates boutique_cyberpunk schema if missing
CREATE DATABASE IF NOT EXISTS boutique_cyberpunk CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE boutique_cyberpunk;

-- Tables (same as migration.sql)
